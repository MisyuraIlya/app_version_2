...
const FilterHead = () => {
    ...
    <div className="clientsAgentSearchWrapper flex-container">
        <div className='col-lg-8'>
            <SearchInput search={searchValue} setSearch={setSearchValue} onActive={setActive}/>
        </div>
        <div className='col-lg-4' style={{display:'flex',justifyContent:'center', alignItems:'end'}}>
