...
import { ConvertNumberToHebrewMonth } from '../helpers/arrayOfMonths';
                    ...
                    <MyCard key={index}>
                        <div className='flex-container body'>
                            ...
                            {(isSuperAgent || isAdmin) && 
                                <div className='col-lg-1 myCenterAlign modalBtn colMobile6 mobileAlign col-6' onClick={() => setTargetModalItem(item)}>
                                    <Wrap>
